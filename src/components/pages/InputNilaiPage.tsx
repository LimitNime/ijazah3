...
export function InputNilaiPage({ showToast }: { showToast: (msg: string, type?: any) => void }) {
                    ...
                    <table className="w-full text-sm">
                      <thead className="sticky top-0 z-10">
                        <tr className="bg-gray-50 border-b border-gray-200">
                          ...
                          {isUjian(selSem) ? (
                            <th className="px-3 py-3 text-xs font-bold text-amber-600 uppercase tracking-wide w-32 text-center">Nilai Ujian</th>
                          ) : (
                            <>

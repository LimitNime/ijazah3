...
const NAV: NavItem[] = [
  ...
  { key: 'nilai',     label: 'Input Nilai',          icon: <PenLine className="w-4 h-4" />, group: 'AKADEMIK' },
  { key: 'rekap',     label: 'Rekap & Cetak',        icon: <Printer className="w-4 h-4" /> },
